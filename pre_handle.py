...
#定义一些参数
add_ori_coprpus="./data/chs-comments/train/tagging_corpus"  #原语料库文件,未经处理的xml格式
shuffled_corpus="./data/chs-comments/train/shuffled_corpus"  #经过随机打乱顺序后的语料库
add_after_pos_corpus="./data/chs-comments/train/pos"  #处理后转换为txt格式的积极语料库文件
add_after_neg_corpus="./data/chs-comments/train/neg"  #处理后转换为txt格式的消极语料库文件
corpus_post="./data/chs-comments/test/corpus"#处理后的语料库,只包含有情感的微博评论数据
binary_label="./data/chs-comments/label/二分类标签"#二分类标签文件
validate_corpus="./data/chs-comments/test/corpus_validation"#验证集,用于模型准确性的比对和标签文件的生成
